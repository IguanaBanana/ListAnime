...
<header data-bs-theme="dark">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          ...
          <p class="text-body-secondary">Bienvenido al proyecto de Biblioteca de animes, donde podras obtener informacion sobre animes recientes y podras votar por cuales te parecen mejores.</p>
        </div>
        <div class="col-sm-4 offset-md-1 py-4">
          <h4>Contacto</h4>
          <ul class="list-unstyled">
            <li><a href="https://twitter.com/?lang=es" class="text-white">Siguenos en Twitter</a></li>
            <li><a href="https://www.facebook.com/" class="text-white">Buscanos on Facebook</a></li>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="Lista-animes.php" class="navbar-brand d-flex align-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" aria-hidden="true" class="me-2" viewBox="0 0 24 24"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>
        <strong>Lista de Animes</strong>
      </a>
